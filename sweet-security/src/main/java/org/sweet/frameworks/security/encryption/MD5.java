 ...
 * javascript implementation of Paul Johnston Copyright (C) Paul Johnston 1999 - 2000. See http://pajhome.org.uk/site/legal.Html
 * for details. Java Version by Thomas Weber (Orange Interactive GmbH)
 */
public final class MD5 {
	/*
	 * Convert a 32-bit number to a hex string with ls-byte first
	 */
	private String hex_chr="0123456789abcdef";
	/*
	 * singleton
	 */
	...
	/*
	 * Convert a string to a sequence of 16-Word blocks, stored as an array. Append padding bits and the length, as described in
	 * the MD5 standard.
	 */
