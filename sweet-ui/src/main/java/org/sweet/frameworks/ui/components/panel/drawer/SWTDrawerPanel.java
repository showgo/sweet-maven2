 ...
 * @modifyrecords:
 */
public class SWTDrawerPanel extends SWTContainer {
	public static final String COMPONENT_FAMILY="SWTDrawerPanel";
	...
	public void encodeAll(FacesContext context) throws IOException{
		try{
			...
			for(UIComponent item:this.getChildren()){
				if(item instanceof SWTDrawerItem) {
