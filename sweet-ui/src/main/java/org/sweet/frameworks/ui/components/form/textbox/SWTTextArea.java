 ...
 * @modifyrecords:
 */
public class SWTTextArea extends SWTControl {
	public static final String COMPONENT_FAMILY="SWTTextArea";
	...
	public void encodeAll(FacesContext context) throws IOException{
		try{
			...
			out.writeAttribute("multiline",attributesMap.get("multiline"),null);
