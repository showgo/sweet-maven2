...
/**
 * 对话框页脚按钮类SWTDialogButtons
 * @filename:SWTDialogButtons
 * @filedescription:
 * @version:1.0.0
 * @author:wugz
 ...
 * @modifyrecords:
 */
public class SWTDialogButtons extends SWTControl {
	public static final String COMPONENT_FAMILY="SWTDialogButtons";
