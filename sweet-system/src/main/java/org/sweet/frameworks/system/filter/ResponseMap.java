...
public class ResponseMap extends LinkedHashMap<String,Object> {
	 ...
	 * 
	 */
	private static final long serialVersionUID=-8147033921969554993L;
	 ...
	 * @return
	 */
	public static ResponseMap fail(Object data){
		ResponseMap map=new ResponseMap();
	...
	private ResponseMap status(int status){
		this.put("status",status);
		return this;
	}

	private ResponseMap msg(Object msg){
		this.put("msg",msg);
		return this;
	}

	private ResponseMap timestamp(){
		this.put("timestamp",System.currentTimeMillis());
		return this;
	}

	private ResponseMap data(Object data){
		this.put("data",data);
		return this;
	}
	...
	public enum HttpStatus{
		...
		public HttpStatus.Series series(){
			return HttpStatus.Series.valueOf((HttpStatus)this);
		}
